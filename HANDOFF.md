...
**Linha de robustez consolidada até `e5f8488`. Último workflow remoto `Quality`: run `30449855101`, aprovado em 29/07/2026. Produção permanece nos deploys `f983dd7`, `b58f955` e `21f09ae`; nenhum dos aprimoramentos abaixo foi deployado.**
