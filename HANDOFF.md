...
**Linha de robustez consolidada até `4f011f2`. Último workflow remoto `Quality` anterior a esse incremento: run `30449118390`, aprovado em 29/07/2026. Produção permanece nos deploys `f983dd7`, `b58f955` e `21f09ae`; nenhum dos aprimoramentos abaixo foi deployado.**
